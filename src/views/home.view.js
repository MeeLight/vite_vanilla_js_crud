...
export default class HomeView extends View {
    ...
    const navComponent = () => {
      ...
      nav.innerHTML = /*html*/ `
        ...
        <ul class="nav__list">
          ...
          <li class="nav__item">
            <a href="/" rel="noopener noreferrer" target="_self">App Info</a>
          </li>
          <li class="nav__item">
            <a
  ...
  main() {
    ...
    document.body.insertBefore(this.#components.navComponent(), document.body.children[1])
    document.body.insertBefore(mainElement, document.body.children[2])
